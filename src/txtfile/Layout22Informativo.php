<?php
namespace txtfile;
class Layout22Informativo extends TxtFile{
    ...
    function __construct($filename, $filepath, $data_header, $data){
        ...
        $header = [
            ...
            new TxtField("cnpj", TxtField::TYPE_STRING, 8, null, null, "|"),
            ...
            new TxtField("modulo_declaracao", TxtField::TYPE_STRING, 1, "", "", "|"),
            new TxtField("tipo_declaracao", TxtField::TYPE_STRING, 1, "", "", "|"),
            new TxtField("prtc_decl_ante", TxtField::TYPE_STRING, 30, "", "", "|"),
            new TxtField("tipo_consolidacao", TxtField::TYPE_STRING, 1, "", "", "|"),
        ...
        $detail = [
            ...
            new TxtField("conta", TxtField::TYPE_INTEGER, 30, null, null, "|"),
            new TxtField("nome_grupo", TxtField::TYPE_STRING, 100, null, null, "|"),
            new TxtField("descr_conta", TxtField::TYPE_STRING, 600, "", "", "|"),
            new TxtField("conta_supe", TxtField::TYPE_STRING, 30, "", "", "|"),
            new TxtField("conta_cosif", TxtField::TYPE_INTEGER, 8, "", "", "|"),
            new TxtField("cod_trib_desif", TxtField::TYPE_INTEGER, 9, "", ""),
        ];
